  ...
  */
  ...
  return (
    <header className="border-b border-border bg-background">
      ...
      {/* TOP HEADER */}
      <div className="bg-[#0f2a66] text-white">
      ...
      <nav
        ...
        } border-t border-border bg-surface md:block`}
      >
                  ...
                  <div
                    className={`${
                      isOpen
                        ? "block"
                        : "hidden"
                    } md:absolute md:left-0 md:top-full md:z-30 md:min-w-[640px] md:border md:border-border md:bg-popover md:shadow-lg`}
                  >
