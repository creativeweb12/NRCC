      ...
      <div className="mx-auto grid max-w-7xl gap-8 px-4 py-10 lg:grid-cols-[1fr_280px]">
        ...
        <section className="prose-invert max-w-none">
          ...
          <p className="text-base leading-relaxed text-foreground">
            <strong>
              This page presents information related to{" "}
              {title}.
            </strong>{" "}
            Detailed content will be published here as per the institute's content management policy and updated periodically by the Web Information Manager.
          </p>

          <p className="mt-4 text-base leading-relaxed text-muted-foreground">
            <strong>
              For specific queries regarding this section, please contact the concerned officer through the{" "}
              <Link
                to="/contact-us"
